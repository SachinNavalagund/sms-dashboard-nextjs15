...
export const calendarEvents = [
  ...
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date(2024, 10, 28, 15, 0),
    end: new Date(2024, 10, 28, 15, 45),
  },

  {
    title: 'Chemistry',
    allDay: false,
    start: new Date(2024, 10, 27, 9, 0),
    end: new Date(2024, 10, 27, 9, 45),
  },
  {
    title: 'History',
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2024, 10, 27, 11, 45),
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date(2024, 10, 27, 12, 0),
    end: new Date(2024, 10, 27, 12, 45),
  },
  {
    title: 'Physics',
    allDay: false,
    start: new Date(2024, 10, 27, 13, 0),
    end: new Date(2024, 10, 27, 13, 45),
  },
  ...
  },
  {
    ...
    end: new Date(2024, 10, 27, 15, 45),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date(2024, 10, 28, 16, 0),
    end: new Date(2024, 10, 28, 16, 45),
  },

  {
    title: 'Physics',
    allDay: false,
    start: new Date(2024, 10, 27, 16, 0),
    end: new Date(2024, 10, 27, 16, 45),
  },
  {
    title: 'Chemistry',
    allDay: false,
