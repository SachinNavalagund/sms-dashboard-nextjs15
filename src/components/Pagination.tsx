  ...
  return (
    <div className="flex items-center justify-between p-4 text-gray-500">
      ...
      <div className="flex items-center gap-2 text-sm">
        <button className="rounded-sm bg-skyD px-2">1</button>
        <button className="rounded-sm">2</button>
        <button className="rounded-sm">3</button>
        ...
        <button className="rounded-sm">10</button>
      </div>
